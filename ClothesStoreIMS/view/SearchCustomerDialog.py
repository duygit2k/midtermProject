...
class SearchCustomerDialog:
    ...
    def setLocation(self):
        ...
        self.__screenWidth = self.__searchCustomerWindow.winfo_screenwidth()
        self.__screenHeight = self.__searchCustomerWindow.winfo_screenheight()
        ...
        self.__searchCustomerWindow.geometry(f'{self.__windowWidth}'
                                             f'x{self.__windowHeight}'
                                             f'+{self.__positionRight}'
                                             f'+{self.__positionTop}')

    def setWindow(self):
        self.__searchCustomerWindow = tk.Toplevel(self.__rootWindow)
        self.__searchCustomerWindow.config(bg="aliceblue")
        self.__searchCustomerWindow.title("Search Customer")
        self.__topLabel = tk.Label(self.__searchCustomerWindow,
                                   height=3,
                                   font=("Arial", 20),
                                   text="Search customer",
                                   bg="aliceblue"
                                   ).pack()
        self.__searchCustomerWindow.grab_set()

    def setTextFields(self):
        self.__txtId = tk.Entry(self.__searchCustomerWindow)
        self.__txtId.place(x=125, y=100, width=240, height=25)
        self.__txtFullName = tk.Entry(self.__searchCustomerWindow)
        self.__txtFullName.place(x=125, y=140, width=240, height=25)
        self.__txtAddress = tk.Entry(self.__searchCustomerWindow)
        self.__txtAddress.place(x=125, y=180, width=240, height=25)
        self.__txtPhoneNumber = tk.Entry(self.__searchCustomerWindow)
        self.__txtPhoneNumber.place(x=125, y=220, width=240, height=25)

    def setButtons(self):
        self.__radio1 = tk.Radiobutton(self.__searchCustomerWindow,
                                       text="ID:",
        ...
        self.__radio2 = tk.Radiobutton(self.__searchCustomerWindow,
                                       text="Full Name:",
                                       variable=self.__choice,
                                       bg="aliceblue",
                                       command=self.radioButtonsActionPerformed,
        ...
        self.__radio3 = tk.Radiobutton(self.__searchCustomerWindow,
                                       text="Address:",
                                       variable=self.__choice,
                                       bg="aliceblue",
                                       command=self.radioButtonsActionPerformed,
        ...
        self.__radio4 = tk.Radiobutton(self.__searchCustomerWindow,
                                       text="Phone Number:",
                                       variable=self.__choice,
                                       bg="aliceblue",
                                       command=self.radioButtonsActionPerformed,
        ...
        self.__btnSearch = tk.Button(self.__searchCustomerWindow, text="Search",
                                     bg="lightyellow",
                                     command=self.btnSearchActionPerformed).place(
            x=100, y=300, width=50, height=35)
        self.__btnCancel = tk.Button(self.__searchCustomerWindow, text="Cancel",
                                     bg="lightyellow",
    ...
    def btnSearchActionPerformed(self):
        ...
        if self.__choice.get() == 0:
            if len(id) > 0:
                self.__parent.searchByIdCallBack(id, 1)
            else:
                messagebox.showerror("Error", "Input fields cannot be left blank!")
        elif self.__choice.get() == 1:
            if len(fullName) > 0:
                self.__parent.searchByFullNameCallBack(fullName, 1)
            else:
                messagebox.showerror("Error", "Input fields cannot be left blank!")
        elif self.__choice.get() == 2:
            if len(address) > 0:
                self.__parent.searchByAddressCallBack(address, 1)
            else:
                messagebox.showerror("Error", "Input fields cannot be left blank!")
        else:
            if len(phoneNumber) > 0:
                self.__parent.searchByPhoneNumberCallBack(phoneNumber, 1)
            else:
                messagebox.showerror("Error", "Input fields cannot be left blank!")


    def btnCancelActionPerformed(self):
        self.__searchCustomerWindow.destroy()
